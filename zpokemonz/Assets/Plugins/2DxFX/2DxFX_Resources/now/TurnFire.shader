...
Shader "2DxFX_Extra_Shaders/TurnFire"
{
Properties
{
...
float2 _Simple_Displacement_1 = SimpleDisplacementUV(i.texcoord,0,_Generate_Fire_1.g*_Generate_Fire_1.a,_Fire_Displacement_Value);
