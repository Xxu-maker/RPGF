...
Shader "2DxFX_Extra_Shaders/TurnFirePixel"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
Fire_Pixel_Size("Fire_Pixel_Size", Range(1, 128)) = 48
Fire_Displacement_Value("Fire_Displacement_Value", Range(-0.3, 0.3)) = -0.026
Fire_Addition("Fire_Addition", Range(0, 4)) = 0.464
...
sampler2D _MainTex;
float _SpriteFade;
float Fire_Pixel_Size;
float Fire_Displacement_Value;
float Fire_Addition;
...
{
float2 PixelUV_1 = PixelUV(i.texcoord,Fire_Pixel_Size);
float4 _Generate_Fire_1 = Generate_Fire(PixelUV_1,0,0,0.041,0.634,1,0);
float2 _Simple_Displacement_1 = SimpleDisplacementUV(i.texcoord,0,_Generate_Fire_1.g*_Generate_Fire_1.a,Fire_Displacement_Value);
...
_MainTex_1 = lerp(_MainTex_1,_MainTex_1*_MainTex_1.a + _PremadeGradients_1*_PremadeGradients_1.a,Fire_Addition * _MainTex_1.a);
