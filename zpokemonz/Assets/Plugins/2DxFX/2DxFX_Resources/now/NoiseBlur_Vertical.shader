...
Shader "2DxFX_Extra_Shaders/NoiseBlur_Vertical"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
Displacement_Value("Displacement_Value", Range(-0.3, 0.3)) = 0.144
...
float2 _Simple_Displacement_1 = SimpleDisplacementUV(i.texcoord,0,_Generate_Line_1.g*_Generate_Line_1.a,Displacement_Value);
