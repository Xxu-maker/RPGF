...
Shader "2DxFX_Extra_Shaders/HologramScanLine"
{
Properties
{
...
float2 _Simple_Displacement_Rotative_1 = SimpleDisplacementRotativeUV(i.texcoord,_Hologram_1,0.3,0.208);
i.texcoord = lerp(i.texcoord,_Simple_Displacement_Rotative_1,0.139);
float4 SourceRGBA_1 = tex2D(_MainTex, i.texcoord);
float2 AnimatedZoomUV_1 = AnimatedZoomUV(i.texcoord,1.261,0.5,0.5,3.034,3.207);
float4 _Generate_Line_1 = Generate_Lines(AnimatedZoomUV_1.y,150,0);
SourceRGBA_1 = lerp(SourceRGBA_1,SourceRGBA_1 * _Generate_Line_1,1);
